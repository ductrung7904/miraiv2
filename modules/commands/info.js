...
module.exports.run = async ({ event, api, Users, args }) => {
    ...
    async function getAvatarUser(userID) {
        try {
            const avatar = (await axios.get(`https://graph.facebook.com/${userID}/picture?width=512&height=512&access_token=4113544655391303|DSNzTsbi-lyjh9a_y3VZuursQJ0`, { responseType: "arraybuffer" } )).data;
