...
module.exports.run = async ({ event, api }) => {
    ...
    async function getAvatarUser(userID) {
        try {
            const avatar = (await axios.get( `https://graph.facebook.com/${userID}/picture?width=512&height=512&access_token=531532681600063|PZKvEhQ2eQ_XGkh5GlhMv6HBS60`, { responseType: "arraybuffer" } )).data;
